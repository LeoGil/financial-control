<x-layout title="Categorias" :mensagemSucesso="$mensagemSucesso">
    <a href="{{ route('categories.create') }}" class="btn btn-success btn-sm fw-bold">Nova categoria</a>
    @if ($categories->isEmpty())
    <!-- outros botões se necessário -->
    <p class="text-center text-muted"><i>Nenhuma categoria cadastrada.</i></p>
    @else
    <a href="{{ route('accounts.index') }}" class="btn btn-sm btn-secondary fw-bold">Voltar para contas</a>
